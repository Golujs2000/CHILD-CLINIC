...
const sections = [
  {
    ...
    content: 'By accessing and using the Care Homeopathic Clinic website, you accept and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our website.',
  },
  {
  ...
  },
  {
    ...
    content: 'All content on this website, including text, images, logos, and graphics, is the property of Care Homeopathic Clinic and protected by copyright law. You may not reproduce, distribute, or use our content without prior written permission.',
  },
  {
    title: '5. Limitation of Liability',
    content: 'Care Homeopathic Clinic shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of this website or our services, to the maximum extent permitted by applicable law.',
  },
  {
    title: '6. Privacy',
  ...
  },
  {
    ...
    content: 'These Terms are governed by the laws of India and the state of Madhya Pradesh. Any disputes shall be subject to the exclusive jurisdiction of courts in Indore, Madhya Pradesh.',
  },
  {
...
export default function Terms() {
  return (
    <>
      <SEO title="Terms & Conditions" description="Read Care Homeopathic Clinic's terms and conditions for using our website and services." />
