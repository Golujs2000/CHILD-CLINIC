...
export default function PrivacyPolicy() {
  return (
    <>
      <SEO title="Privacy Policy" description="Read Care Homeopathic Clinic's privacy policy to understand how we collect, use, and protect your personal information." />
